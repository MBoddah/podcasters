                ...
                <div class="podcasts__episodes">
                    ...
                    <div class="podcasts__episode episode">
                        ...
                        <div class="episode__text">
                            <div class="episode__title">
                                <h3>Выпуск 5: Гостевой</h3>
                            </div>
                            <div class="episode__description">
                                <p>Казалось бы, Муж в гостях у Лиги, но на деле Лига в гостях у Мужа. Идеальный Муж не только почесал с нами языками, но и обучил своему кулинарному Дзюцу!
                                    <br> В юбилейном пятом выпуске даже усечённый по самое нЕльзя состав не помешал нам узнать:
                                        <br>- душещипательную и витиеватую историю жизни Идеального Мужа;
                                        <br>- подробности закулисной жизни пауэрлифтеров;
                                        <br>- можно ли совмещать спорт и киберспорт;
                                        <br>- секрет и д е а л ь н о г о отпуска;
                                        <br>- покорит ли наш гость TikTok.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="podcasts__episode episode">
                        ...
                        <div class="episode__text">
                            ...
                            <div class="episode__description">
                                <p>Несколько фактов о числе "четыре" (4 (IV (100₂ (четвертушка)))):
                                    <br>- это натуральное число, расположенное между 3 и 5;
                                    <br>- именно столько метров имеет в диаметре труба, в которой мы записали этот выпуск подкаста;
                                    <br>- столько участников было в первом пилоте.
                    ...
                    <div class="podcasts__episode episode">
                        ...
                        <div class="episode__text">
                            ...
                            <div class="episode__description">
                                <p>Во втором пилоте нашего концептуального подкаста мы обсудили дистанционное обучение, закостенелость старого поколения и бальзамический уксус.
                                    <br>Ставь лайк, если масло черного тмина – западная рэпчина.
                    ...
                    <div class="podcasts__episode episode">
                        ...
                        <div class="episode__text">
                            <div class="episode__title">
                                <h3>Выпуск 1: Пилот</h3>
                            </div>
                            <div class="episode__description">
                                <p>
                                    В пилотном выпуске мы сразу же очертили список своих врагов, нашли секрет победы на выборах в президенты США, обсосали "Метод" Юрия Быкова и безуспешно зовём #пиврумтула стать нашим спонсором.
                                    <br>
                                    <br>И да, гастрошумы это не баг, это фича.
                                </p>
                            </div>
                        </div>
                        <div class="episode__buttons">
